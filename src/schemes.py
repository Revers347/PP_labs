...
''''''
post blog
curl -u "user2:12345" -X POST -H "Content-Type:application/json" --data-binary "{\"id\": 5, \"category_id\": 1, \"title\": \"blog1\", \"contents\": \"abc defg\", \"tags\": \"1, 2\"}" http://localhost:5000/blog
post blog (error)
